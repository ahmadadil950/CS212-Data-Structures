// Provided by:   ____________Ahmad Adil__________
// Email Address: ____________ahmadadil950@gmail.com________
// FILE: sequence2.h
...
//     Precondition: The capacity of the dynamic array is the same as the 
//     capcaity of the sequence that is being copied.
//     Postcondition: After dynamic array has been allocated, the items 
//     may be copied in the new array
//
...
namespace main_savitch_4
{
    ...
    public:
        ...
        value_type current( ) const;
    private:
    value_type *m_data; // pointer to the dynamic array
    size_type m_currentInd; // The current index of the array
    size_type m_cellTaken;  // How many "cells" of the array are used
