// PROVIDED BY: ________Ahmad Adil ahmadadil950@gmail.com________ (your name and email address)
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    public:
        ...
        value_type current( ) const;
    private:
        node *m_head; // first item in sequence
        node *m_tail; // last item in sequence
        node *m_current_node; // Current item in the sequence
        node *m_precurrent_node; // item prior of current
        size_type m_total_nodes; // Total number of nodes
    };
}
